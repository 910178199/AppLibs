package com.example.superman.expandabletextview.ui;
...
import com.example.superman.expandabletextview.R;
import com.example.superman.expandabletextview.utlis.OsUtils;
...
public class DialogHelper {
    ...
    public static AppCompatDialog getADDialog(Context context, int layout) {
        AppCompatDialog appCompatDialog = new AppCompatDialog(context, R.style.ad_dialog);
        appCompatDialog.setContentView(layout);
        int[] screenWidthHeight = OsUtils.getScreenWidthHeight(context);
